    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_img', models.ImageField(blank=True, null=True, upload_to=core.models.image_file_path)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, max_length=255, null=True)),
                ('status', models.CharField(choices=[('blocked', 'Blocked'), ('not started', 'Not Started'), ('done', 'Done'), ('doing', 'Doing'), ('planning', 'Planning')], default='not started', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('category', models.CharField(blank=True, max_length=255, null=True)),
                ('status', models.CharField(choices=[('planned', 'Planned'), ('pending', 'Pending'), ('complete', 'Complete')], default='planned', max_length=300)),
